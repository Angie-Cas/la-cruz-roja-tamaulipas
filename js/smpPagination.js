            ...
            if($blocks.length > perPage) {
                ...
                for (var i = perPage; i < $blocks.length; i++) {
                    ...
                    if(i === $blocks.length-1) {
                        ...
                        $('.smpPagination--pagination-nav')
                            .append($('<button>').text('<').addClass('smpPagination--pagination prev'))
                            .append($('<span>').text('1 - ' + perPage).addClass('smpPagination--pagination-counter'))
                            .append($('<button>').text('>').addClass('smpPagination--pagination next')) ;
                    }
                }
                ...
                return {
                    ...
                    updateCounter: function() {
                        ...
                        $('.smpPagination--pagination-counter').text((min+1) +' - ' + max) ;
                    },
                    max: function(){
